...
<body style="margin:0;padding:0;background:#0a0e1a;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;">
  <div style="max-width:600px;margin:0 auto;padding:40px 24px;">
    ...
    <div style="text-align:center;margin-bottom:32px;">
      ...
      <h1 style="color:#f1f5f9;font-size:24px;font-weight:800;margin:0;">
        CELPIP AI Coach
      </h1>
    </div>
    ...
    <div style="background:#1a1f2e;border-radius:16px;padding:32px;border:1px solid rgba(255,255,255,0.06);">
      <h2 style="color:#f1f5f9;font-size:20px;font-weight:700;margin:0 0 12px;">
        Hey ${firstName}! 👋
      </h2>
      <p style="color:#94a3b8;font-size:15px;line-height:1.6;margin:0 0 20px;">
        Welcome to CELPIP AI Coach — Canada's AI-powered CELPIP preparation platform.
        You're now part of a community of test-takers working toward their Canadian dreams.
      </p>

      <h3 style="color:#f1f5f9;font-size:16px;font-weight:700;margin:0 0 12px;">
      ...
      <div style="text-align:center;margin:24px 0 8px;">
        <a href="https://celpipaicoach.com/dashboard" 
           style="display:inline-block;padding:14px 32px;background:linear-gradient(135deg,#cc0000,#ff3b3b);color:white;text-decoration:none;border-radius:12px;font-weight:700;font-size:16px;">
    ...
    <div style="background:rgba(255,59,59,0.06);border:1px solid rgba(255,59,59,0.12);border-radius:12px;padding:20px;margin-top:16px;text-align:center;">
      <p style="color:#ff6b6b;font-size:14px;font-weight:700;margin:0 0 4px;">
        ✨ Want AI-powered coaching?
      </p>
      <p style="color:#94a3b8;font-size:13px;margin:0;">
        Try Pro free for 3 days — AI feedback, mock exams, adaptive difficulty & more.
        <a href="https://celpipaicoach.com/pricing" style="color:#ff3b3b;text-decoration:underline;">See plans</a>
      </p>
    </div>
    ...
    <div style="text-align:center;margin-top:32px;padding-top:20px;border-top:1px solid rgba(255,255,255,0.06);">
      <p style="color:#475569;font-size:12px;margin:0;">
        CELPIP AI Coach · Vancouver, Canada<br>
        <a href="https://celpipaicoach.com" style="color:#64748b;">celpipaicoach.com</a>
      </p>
    </div>
  </div>
</body>
